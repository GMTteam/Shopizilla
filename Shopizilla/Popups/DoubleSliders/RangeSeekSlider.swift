...
@IBDesignable open class RangeSeekSlider: UIControl {
    ...
    open var minLabelFont: UIFont = UIFont(name: FontName.ppRegular, size: 12.0) ?? UIFont.systemFont(ofSize: 12.0) {
        didSet {
    ...
    open var maxLabelFont: UIFont = UIFont(name: FontName.ppRegular, size: 12.0) ?? UIFont.systemFont(ofSize: 12.0) {
        didSet {
    ...
    private func setup() {
        ...
        let lblFont = UIFont(name: FontName.ppRegular, size: labelFontSize) ?? UIFont.systemFont(ofSize: labelFontSize)
        
        minLabelFont = lblFont
